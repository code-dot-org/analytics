...
with
    unpivoted_data as (
        ...
        {{ unpivot_big_table("base_external_datasets__ap_school_level_exam_results_2023", 8) }}
    )
    ,renamed_cols as (
        select
            examyr4 as exam_year,
            exam as exam_subject,
            ...
            --ap_school_type                    --note: this one of the 8 fields we pivot around, but for these data it's a dup with analysis_school_type; keeping one
